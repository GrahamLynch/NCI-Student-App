package com.example.x16354406.nfcreader.record;

/**
 * Created by x16354406 on 10/04/2018.
 */
...
import com.example.x16354406.nfcreader.*;
...
public class SmartPoster implements ParsedNdefRecord{
     ...
     */
    private final com.example.x16354406.nfcreader.UriRecord mUriRecord;
     ...
     */
    private final com.example.x16354406.nfcreader.SmartPoster.RecommendedAction mAction;
    ...
    public SmartPoster(com.example.x16354406.nfcreader.UriRecord uri, TextRecord title, com.example.x16354406.nfcreader.SmartPoster.RecommendedAction action, String type) {
    ...
    public com.example.x16354406.nfcreader.UriRecord getUriRecord() {
        return mUriRecord;
    }
    ...
    public static com.example.x16354406.nfcreader.SmartPoster parse(NdefRecord record) {
    ...
    public static com.example.x16354406.nfcreader.SmartPoster parse(NdefRecord[] recordsRaw) {
        try {
            Iterable<ParsedNdefRecord> records = NdefMessageParser.getRecords(recordsRaw);
            com.example.x16354406.nfcreader.UriRecord uri = Iterables.getOnlyElement(Iterables.filter(records, com.example.x16354406.nfcreader.UriRecord.class));
            TextRecord title = getFirstIfExists(records, TextRecord.class);
            com.example.x16354406.nfcreader.SmartPoster.RecommendedAction action = parseRecommendedAction(recordsRaw);
            String type = parseType(recordsRaw);
            return new com.example.x16354406.nfcreader.SmartPoster(uri, title, action, type);
    ...
    public enum RecommendedAction {
        ...
        private static final ImmutableMap<Byte, com.example.x16354406.nfcreader.SmartPoster.RecommendedAction> LOOKUP;
        static {
            ImmutableMap.Builder<Byte, com.example.x16354406.nfcreader.SmartPoster.RecommendedAction> builder = ImmutableMap.builder();
            for (com.example.x16354406.nfcreader.SmartPoster.RecommendedAction action : com.example.x16354406.nfcreader.SmartPoster.RecommendedAction.values()) {
    ...
    private static com.example.x16354406.nfcreader.SmartPoster.RecommendedAction parseRecommendedAction(NdefRecord[] records) {
        NdefRecord record = getByType(ACTION_RECORD_TYPE, records);
        if (record == null) {
            return com.example.x16354406.nfcreader.SmartPoster.RecommendedAction.UNKNOWN;
        }
        byte action = record.getPayload()[0];
        if (com.example.x16354406.nfcreader.SmartPoster.RecommendedAction.LOOKUP.containsKey(action)) {
            return com.example.x16354406.nfcreader.SmartPoster.RecommendedAction.LOOKUP.get(action);
        }
        return com.example.x16354406.nfcreader.SmartPoster.RecommendedAction.UNKNOWN;
    }
