...
public class UriRecord implements ParsedNdefRecord{
     ...
     *         containing a URI.
     */
    public static com.example.x16354406.nfcreader.UriRecord parse(NdefRecord record) {
    ...
    private static com.example.x16354406.nfcreader.UriRecord parseAbsolute(NdefRecord record) {
        byte[] payload = record.getPayload();
        Uri uri = Uri.parse(new String(payload, Charset.forName("UTF-8")));
        return new com.example.x16354406.nfcreader.UriRecord(uri);
    }

    /** Parse an well known URI record */
    private static com.example.x16354406.nfcreader.UriRecord parseWellKnown(NdefRecord record) {
